...
func TestLoadConfig(t *testing.T) {
	...
	assert.Equal(t, exporter.LogEndpoint, defaultEndpoint)
	assert.Equal(t, exporter.TraceEndpoint, defaultEndpoint)
	assert.Equal(t, exporter.MetricEndpoint, defaultEndpoint)
	assert.Equal(t, exporter.ApiKey, "fake")
}
